...
img=Image.open('F:/Desktop/All/language/VSCODEWORKSPACE/Python/Class/计算机视觉/SuperResolution/SRCNN/SRCNN-WBQ/data/my/img_003_SRF_2_LR.png',mode="r")  #选择自己图片的路径
imgT=transforms.ToTensor()(img).unsqueeze(0)

#导入模型
net=paddle.jit.load("./25_4/edsr_paddle")
